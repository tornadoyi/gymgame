...
class Render(object):
    ...
    def update(self):
        ...
        all_x = [_.position.x for _ in self._map.players] + [_.position.x for _ in self._map.npcs]
        all_y = [_.position.y for _ in self._map.players] + [_.position.y for _ in self._map.npcs]
